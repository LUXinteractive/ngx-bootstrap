...
import { ComponentLoader, ComponentLoaderFactory } from 'lux-ngx-bootstrap/component-loader';
...
export class BsDatepickerDirective implements OnInit, OnDestroy, OnChanges {
  ...
  setConfig(): void {
    this._config = Object.assign({}, this._config, this.bsConfig, {
      ...
      initialViewDate: this.initialViewDate || this.bsConfig && this.bsConfig.initialViewDate,
